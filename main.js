   ...
   if (pairingCode && !XeonBotInc.authState.creds.registered) {
    ...
    XeonBotInc.ev.on('messages.upsert', async chatUpdate => {
        ...
        try {
            ...
            require("./IGWE-BUG-BOT")(XeonBotInc, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
			...
			await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`𝕀𝔾𝕎𝔼-𝕏𝔹𝕌𝔾`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
	        console.log(chalk.magenta(`\n${themeemoji} YT CHANNEL: IGWE-tech`))
            console.log(chalk.magenta(`${themeemoji} GITHUB: PAPAIGWE241`))
            console.log(chalk.magenta(`${themeemoji} INSTAGRAM: @its_PAPAIGWE `))
